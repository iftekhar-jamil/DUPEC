        ...
        <nav class="navbar navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a href="<?php echo site_url('login/gotoUser'); ?>" class="navbar-brand"><b>du</b>PEC</a>
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo site_url('admin/newField'); ?>">Reserve Field</a></li>
                        <li><a href="<?php echo site_url('register/showUsers'); ?>">Meet your friends!</a></li>
                        <li><a href="<?php echo site_url('live/liveScore'); ?>">Live Match</a></li>
                        <li><a href="<?php echo site_url('Swimmingpool/information'); ?>">Swimmingpool</a></li>
