<html lang="en">
    ...
    <body>
        <div id="content">
            ...
            <button type="button" class="btn btn-success" onclick="window.location='<?php echo site_url("register/addUserByAdmin");?>'">Add New User</button>

            <button type="button" class="btn btn-success" onclick="window.location='<?php echo site_url("admin/");?>'">Manage requests</button>
